...
(function ($, window, document) {
    ...
    $.fn.adaptiveMenu = function (options) {
        ...
        return this.each(function () {
            function init() {
                widget.before('<a href="javascript:void(0)" id="open_menu" class="adaptive-menu__open adaptive-menu__open--is-hidden"><span><b>open</b></span></a>');
                widget.prepend('<a href="javascript:void(0)" id="close_menu" class="adaptive-menu__close adaptive-menu__close--is-hidden"><span>close</span></a>');
